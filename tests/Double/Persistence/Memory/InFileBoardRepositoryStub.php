...
namespace App\Tests\Double\Persistence\Memory;
...
final class InFileBoardRepositoryStub
{

    public static function repository(): BoardRepository
    {
        return (
        new class() implements BoardRepository
        {
